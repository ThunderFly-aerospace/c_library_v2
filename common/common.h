...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_NAV_ROI=80, /* Sets the region of interest (ROI) for a sensor set or the vehicle itself. This can then be used by the vehicles control system to control the vehicle attitude and the attitude of various sensors such as cameras. |1: mode.| 2: Waypoint index/ target ID. (see MAV_ROI enum)| 3: ROI index (allows a vehicle to manage multiple ROI's)| 4: Empty| 5: x the location of the fixed ROI (see MAV_FRAME)| 6: y| 7: z|  */
   ...
   MAV_CMD_DO_REPOSITION=192, /* Reposition the vehicle to a specific WGS84 global position. |1: Ground speed, less than 0 (-1) for default| 2: Bitmask of option flags.| 3: Reserved| 4: Yaw heading, NaN for unchanged. For planes indicates loiter direction (0: clockwise, 1: counter clockwise)| 5: Latitude (deg * 1E7)| 6: Longitude (deg * 1E7)| 7: Altitude (meters)|  */
   ...
   MAV_CMD_NAV_SET_YAW_SPEED=213, /* Sets a desired vehicle turn angle and speed change. |1: Yaw angle to adjust steering by.| 2: speed - normalized to 0 .. 1| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
   ...
   MAV_CMD_DO_ENGINE_CONTROL=223, /* Control vehicle engine. This is interpreted by the vehicles engine controller to change the target engine state. It is intended for vehicles with internal combustion engines |1: 0: Stop engine, 1:Start Engine| 2: 0: Warm start, 1:Cold start. Controls use of choke where applicable| 3: r the vehicle has gained the specified height. Used in VTOL vehicles during takeoff to start engine after the aircraft is off the ground. Zero for no delay.| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
   ...
   MAV_CMD_PREFLIGHT_CALIBRATION=241, /* Trigger calibration. This command will be only accepted if in pre-flight mode. Except for Temperature Calibration, only one sensor should be set in a single message and all others should be zero. |1: ion, 3: gyro temperature calibration| 2: 1: magnetometer calibration| 3: 1: ground pressure calibration| 4: 1: radio RC calibration, 2: RC trim calibration| 5: 1: accelerometer calibration, 2: board level calibration, 3: accelerometer temperature calibration, 4: simple accelerometer calibration| 6: 1: APM: compass/motor interference calibration (PX4: airspeed calibration, deprecated), 2: airspeed calibration| 7: 1: ESC calibration, 3: barometer temperature calibration|  */
   MAV_CMD_PREFLIGHT_SET_SENSOR_OFFSETS=242, /* Set sensor offsets. This command will be only accepted if in pre-flight mode. |1: Sensor to adjust the offsets for: 0: gyros, 1: accelerometer, 2: magnetometer, 3: barometer, 4: optical flow, 5: second magnetometer, 6: third magnetometer| 2: X axis offset (or generic dimension 1), in the sensor's raw units| 3: Y axis offset (or generic dimension 2), in the sensor's raw units| 4: Z axis offset (or generic dimension 3), in the sensor's raw units| 5: Generic dimension 4, in the sensor's raw units| 6: ensor's raw units| 7: Generic dimension 6, in the sensor's raw units|  */
   ...
   MAV_CMD_VIDEO_START_CAPTURE=2500, /* Starts video capture (recording). Use NaN for reserved values. |1: Video Stream ID (0 for all streams)| 2: Frequency CAMERA_CAPTURE_STATUS messages should be sent while recording (0 for no messages, otherwise frequency)| 3: Reserved (all remaining params)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
   MAV_CMD_VIDEO_STOP_CAPTURE=2501, /* Stop the current video capture (recording). Use NaN for reserved values. |1: Video Stream ID (0 for all streams)| 2: Reserved (all remaining params)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
   ...
   MAV_CMD_NAV_FENCE_CIRCLE_INCLUSION=5003, /* Circular fence area. The vehicle must stay inside this area.
         |1: Radius.| 2: Reserved| 3: Reserved| 4: Reserved| 5: Latitude| 6: Longitude| 7: ed|  */
   ...
   MAV_CMD_WAYPOINT_USER_3=31002, /* User defined waypoint item. Ground Station will show the Vehicle as flying through this item. |1: User defined| 2: User defined| 3: User defined| 4: User defined| 5: Latitude unscaled| 6: Longitude unscaled| 7: Altitude (MSL), in meters|  */
   MAV_CMD_WAYPOINT_USER_4=31003, /* User defined waypoint item. Ground Station will show the Vehicle as flying through this item. |1: User defined| 2: User defined| 3: User defined| 4: User defined| 5: Latitude unscaled| 6: Longitude unscaled| 7: Altitude (MSL), in meters|  */
   MAV_CMD_WAYPOINT_USER_5=31004, /* User defined waypoint item. Ground Station will show the Vehicle as flying through this item. |1: User defined| 2: User defined| 3: User defined| 4: User defined| 5: Latitude unscaled| 6: Longitude unscaled| 7: Altitude (MSL), in meters|  */
...
{
   MAV_CMD_ACK_OK=1, /* Command / mission item is ok. |1: Reserved (default:0)| 2: Reserved (default:0)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
   MAV_CMD_ACK_ERR_FAIL=2, /* Generic error message if none of the other reasons fails or if no detailed error reporting is implemented. |1: Reserved (default:0)| 2: Reserved (default:0)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
   MAV_CMD_ACK_ERR_ACCESS_DENIED=3, /* The system is refusing to accept this command from this source / communication partner. |1: Reserved (default:0)| 2: Reserved (default:0)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
   MAV_CMD_ACK_ERR_NOT_SUPPORTED=4, /* Command or mission item is not supported, other commands would be accepted. |1: Reserved (default:0)| 2: Reserved (default:0)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
   MAV_CMD_ACK_ERR_COORDINATE_FRAME_NOT_SUPPORTED=5, /* The coordinate frame of this command / mission item is not supported. |1: Reserved (default:0)| 2: Reserved (default:0)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
   ...
   MAV_CMD_ACK_ERR_X_LAT_OUT_OF_RANGE=7, /* The X or latitude value is out of range. |1: Reserved (default:0)| 2: Reserved (default:0)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
   MAV_CMD_ACK_ERR_Y_LON_OUT_OF_RANGE=8, /* The Y or longitude value is out of range. |1: Reserved (default:0)| 2: Reserved (default:0)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
   MAV_CMD_ACK_ERR_Z_ALT_OUT_OF_RANGE=9, /* The Z or altitude value is out of range. |1: Reserved (default:0)| 2: Reserved (default:0)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
...
#include "./mavlink_msg_rotor_frequency.h"
